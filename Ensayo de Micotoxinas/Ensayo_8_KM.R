...
survfits <- list(
  "Control Sac" = survfit(Surv(tiempoControlSac,controlSac) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "Control PGQ" = survfit(Surv(tiempoControlPGBQ,controlPGBQ) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "BbQ 150 µL" = survfit(Surv(tiempoBbQ150,BbQ150) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "BbQ 300 µL" = survfit(Surv(tiempoBbQ300,BbQ300) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "BbQ 450 µL" = survfit(Surv(tiempoBbQ450,BbQ450) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "BbQ 600 µL" = survfit(Surv(tiempoBbQ600,BbQ600) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log"),
  "BbQ 750 µL" = survfit(Surv(tiempoBbQ750,BbQ750) ~ 1, data = df_ensayo_8, type = "kaplan-meier", conf.type = "log-log")
)
...
df_combinado_7 <- rbind(df_Bb150, df_Bb300)
